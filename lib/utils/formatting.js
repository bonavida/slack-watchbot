...
var log = function(websites) {
     ...
     websites.forEach(function(website) {
         ...
         msg += "*" + website.name + "*" +
                ...
                "State: " + ((website.status==="up") ? "Up" : "Down") + "\n";
        if (website.numIncidencies !== 0) {
            ...
            if ((website.status==="down")) {
                ...
                msg += "Down since " + getFormatedDate(firstCheckedDown) + "\n" +
                       "Last time checked was on " + getFormatedDate(lastCheckedDown) + "\n" +
                       "Number of times it's been down: " + website.numIncidencies + "\n";
            } else {
                msg += "Number of times it's been down: " + website.numIncidencies + "\n" +
                       "Last time down was on " + getFormatedDate(lastCheckedDown) + "\n";
            }
        } else {
            msg += "Number of times it's been down: " + website.numIncidencies + "\n";
        }
