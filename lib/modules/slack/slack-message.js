...
var add = function(website, callback) {
    WebsiteService.add(website, function(err, msg) {
        ...
        if (err) {
            ...
            UserService.createOrUpdate(website.user, function(err, user, created) {
                if (err) {
...
var remove = function(website, callback) {
    WebsiteService.remove(website, function(resp) {
        ...
        if (!resp.removed) {
            ...
            watchbot.remove(website.name);
            UserService.removeWebsite(website.name, function(err, removeCron) {
                if (err) {
                    console.log("Error: " + err);
                } else if (removeCron) {
